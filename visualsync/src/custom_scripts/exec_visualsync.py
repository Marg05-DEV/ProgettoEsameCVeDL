...
def run_pipeline(group_id, start_sec, end_sec, fps, start_from_step=None):
    ...
    pipeline_steps = [
        ...
        ("Passo 8: Run CoTracker", [
            ...
            "python src/run_cotracker_all.py --dataset_root \"$DATA_ROOT\" --track_root \"$TRACK_ROOT\" --gpu 0 --mask_prefix \"$MASK_PREFIX\" --only fpv --dynamic_interval 12 --dynamic_grid_step 15 --max_query_per_batch 120 --skip_exist"
        ]),
